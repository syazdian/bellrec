...
{
    public class SynchronizedStapleDbContextFactory : IStapleContextFactory
    {
        private readonly IDbContextFactory<StapleSourceContext> dbContextFactory;
        ...
        public const string dbFilename = "StapleSource.sqlite3";

        public SynchronizedStapleDbContextFactory(
            IJSRuntime js,
            IDbContextFactory<StapleSourceContext> dbContextFactory)
        {
            Js = js;
