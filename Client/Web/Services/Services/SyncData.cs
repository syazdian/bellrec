...
public class SyncData : ISyncData
{
    ...
    public async Task FetchDataFromServerDb()
    {
        try
        {
            ...
            //    // var dbcount = await _httpClient.GetFromJsonAsync<BellStapleCountDto>($"https://dev.tools.staples.ca/BellServices/Reconciliation/api/SyncData/FetchCountServerDatabase");
            ...
            //        // var bellList = await _httpClient.GetFromJsonAsync<List<BellSourceDto>>($"https://dev.tools.staples.ca/BellServices/Reconciliation/api/SyncData/GetBellSourceitems/{startBellCount}/{lastBellCount}");
            ...
            //        // var staplesList = await _httpClient.GetFromJsonAsync<List<StaplesSourceDto>>($"https://dev.tools.staples.ca/BellServices/Reconciliation/api/SyncData/GetStaplesSourceItems/{startStapleCount}/{lastStapleCount}");
